...
def main():
    parser = argparse.ArgumentParser(description="Créer un fichier PPTX à partir d'arguments et l'ouvrir")
    ...
    fichier = creer(args.id, args.toko_tena, args.andininydeb_tena, args.andininyfin_tena)
    openFile(fichier)
